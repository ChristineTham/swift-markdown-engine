...
struct PasteStructureGuardTests {
    ...
    func structural() {
        let cases: [(String, String)] = [
            ...
            ("ul with attrs", "<ul class=\"x\"><li>One</li></ul>"),
    ...
    func plain() {
        let cases: [(String, String)] = [
            ...
            ("span only", "<span style=\"color:red\">word</span>"),
            ("bold word", "a <b>bold</b> word"),
            ("italic word", "a <i>slanted</i> word"),
            ("lone link", "see <a href=\"https://example.com\">here</a>"),
            ("single paragraph", "<p>Just a paragraph of text.</p>"),
